...
public class Records {
    ...
    public static void main(String[] args) {
        ...
        log.log(System.Logger.Level.INFO, point.x());
        log.log(System.Logger.Level.INFO, point.y());
        log.log(System.Logger.Level.INFO, point.toString());
        log.log(System.Logger.Level.INFO, point.hashCode());
        log.log(System.Logger.Level.INFO, point.equals(new Point(2, 3)));

        try {
            new ValidatedPoint(-1, 0);
        } catch (IllegalArgumentException e) {
            log.log(System.Logger.Level.INFO, "Exception: " + e.getLocalizedMessage());
        }

        final PointOverride pointOverride = new PointOverride(-10, -5);
        log.log(System.Logger.Level.INFO, pointOverride.x());
        log.log(System.Logger.Level.INFO, pointOverride.y());

        record RecordInline(int x, int y) {
        }

        final RecordInline recordInline = new RecordInline(point.x(), point.y());
        log.log(System.Logger.Level.INFO, recordInline.x());
        log.log(System.Logger.Level.INFO, recordInline.y());
